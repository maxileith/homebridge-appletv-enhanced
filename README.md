...
| `mediaTypes`                 | edia types for which a motion sensor is created that triggers when the according media type is present on the Apple TV                                                                                                                                                                                                                                                                                                  | `array[string]` | `music`, `tv`, `unknown`, `video`                                                                                                                                                                                                                             | `["music", "video"]`    |
| `deviceStates`               | Device states for which a motion sensor is created that triggers when the according device state is present on the Apple TV                                                                                                                                                                                                                                                                                             | `array[string]` | `idle`, `loading`, `paused`, `playing`, `seeking`, `stopped`                                                                                                                                                                                                  | `["playing", "paused"]` |
...
| `logLevel`                   | Set the log level. (0 - None; 1 - Error; 2 - Warn; 3 - Info; 4 - Debug; 5 - Extended Debug)                                                                                                                                                                                                                                                                                                                             | `integer`       | 0 - 5                                                                                                                                                                                                                                                         | `3`                     |
