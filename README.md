    ...
    "deviceSpecificOverrides": [
        {
            ...
            "disableInputs": true,
            "overrideDisableRemote": true,
            "disableRemote": true,
            "overrideDisableSpeaker": true,
            "disableSpeaker": true,
...
| `disableRemote`              | Don't create remote. Useful for older devices with limited RAM.                                                                                                                                                                                                                                                                                                                                                                                                                                | `boolean`       |                                                                                                                                                                                                                                                                              | `false`                                                     |
| `disableSpeaker`             | Don't create a separate speaker service for volume control.                                                                                                                                                                                                                                                                                                                                                                                                                                    | `boolean`       |                                                                                                                                                                                                                                                                              | `false`                                                     |
